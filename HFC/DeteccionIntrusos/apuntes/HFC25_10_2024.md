...
2. Protocolo (Ahora en *Snort* 3 se permiten protocolos de capa de aplicación)
...
- ***block***: Bloquea el paquete actual y todos los subsecuentes.
- ***drop***: "Suelta" el paquete
...
Por ejemplo, con algo de investigación, hice esta regla para detectar una solictud ping *ICMP* a mi celular.

```rules
alert icmp $EXTERNAL_NET any -> 192.168.99.137 any
(
msg:"Ping a mi celular";
icode:=0;
itype:=8;
sid:1000001;
)
