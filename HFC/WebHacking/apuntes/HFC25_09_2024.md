...
Los **códigos de respuesta** se utilizan para determinar de manera sencilla el estado de la solicitud.

El **cuerpo** de la respuesta, separado por el necesario salto de línea, es el recurso solicitado por la petición, ya sea un archivo *html*, *css*, *javascript*, imágenes, etc.
...
Antes mencionamos los **encabezados HTTP**
